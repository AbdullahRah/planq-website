        ...
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative w-full">
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              {/* Compliance card - comes from left */}
              <div
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="mt-3 max-w-md text-sm leading-relaxed text-white/90 md:text-base">
                    Every sheet checked against the NBC. Every flag cited to a real clause.
                  </p>
                </div>
              </div>

              {/* Consistency card - comes from right */}
              <div
                className="relative aspect-[4/3] overflow-hidden rounded-2xl"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="mt-3 max-w-md text-sm leading-relaxed text-white/90 md:text-base">
                    Every sheet compared to every other. Door D-01 disagrees? You'll know.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          <p className="text-xs uppercase tracking-widest text-muted-foreground">
            How planq reviews a package
          </p>
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            Upload PDFs, images, or DXF. Planq pulls every room, door, corridor, stair, and
            dimension off the sheets, compares them against the NBC, and returns a graded list of
            issues — critical, major, minor — with the exact section number behind each call.
          </p>
        </div>
      </div>
    </section>
