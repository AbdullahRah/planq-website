...
export function TechnologySection() {
  ...
  const descriptionText = "Plan review is the bottleneck nobody owns. You sketched it, your engineer stamped it, your drafter cleaned it up. Then it sits in a city queue for two months and comes back with twelve red marks — half of them width minimums, the other half door swings on the wrong sheet. Run the package through planq and see the list before lunch.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Plan", "review,", "in minutes."].map((word, index) => {
